...
public class LineUpController implements ControllerInterface {
	...
	public void saveButtonClicked() {
		...
		if (currentFormation != m.getFormation() || fController.getCurrentPlayers() != m.getLineUp()) {
			Controller.getInstance().save(fController.getCurrentPlayers(), currentFormation);
		} else {
			// Nix zu speichern
		}
	}
