		...
		for (Node n : formationFrame.getChildren()) {
			((Label) n).setOnMouseClicked(new EventHandler<Event>() {
				...
				public void handle(Event event) {
					...
					//Die Klasse Player koennte eine Funktion: generate Label enthalten.
					
					Position po = Position.Keeper;
					for(Player p : players){
						//GetText muss durch etwas anderes ersetzt werden, denn im Labelnamen steht nicht immer nur der Name
