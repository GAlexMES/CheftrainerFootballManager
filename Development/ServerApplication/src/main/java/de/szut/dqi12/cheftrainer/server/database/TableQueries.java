...
public class TableQueries {
	...
	public static final String SPIELTAG_QUERY = "CREATE TABLE `Spieltag` (`ID`INTEGER PRIMARY KEY AUTOINCREMENT,`Saison`INTEGER,`Spieltag` INTEGER, `Heim_Verein_ID` INTEGER, `Gast_Verein_ID` INTEGER, `Ergebnis` TEXT, `URL` TEXT)";
